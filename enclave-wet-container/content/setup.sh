...
echo "TIMESTAMP ENCLAVE_EXTRACT_RUNNER_START `date -Ins`"
mkdir -p /app/github-runner/
tar --zstd -xf /app/github-runner.tar.zst
rm /app/github-runner.tar.zst
chown -R runner:runner /app/github-runner
echo "TIMESTAMP ENCLAVE_EXTRACT_RUNNER_END `date -Ins`"

echo "TIMESTAMP ENCLAVE_EXTRACT_HOME_START `date -Ins`"
mkdir -p /home/runner
tar --zstd -xf /home/runner.tar.zst
rm /home/runner.tar.zst
chown -R runner:runner /home/runner
echo "TIMESTAMP ENCLAVE_EXTRACT_HOME_END `date -Ins`"
